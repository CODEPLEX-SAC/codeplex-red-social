...
import { SECCIONES, TAB_ALIAS, ICONOS_SECCION } from "@/capacidades/perfiles/perfil-propio/componentes/editar-perfil/editar-perfil.constantes";
import { tieneIncompleto } from "@/capacidades/perfiles/perfil-propio/componentes/editar-perfil/editar-perfil.ayudantes";
import SecDetalles from "@/capacidades/perfiles/perfil-propio/componentes/editar-perfil/secciones/SecDetalles";
import SecDatosPersonales from "@/capacidades/perfiles/perfil-propio/componentes/editar-perfil/secciones/SecDatosPersonales";
import SecEmpleo from "@/capacidades/perfiles/perfil-propio/componentes/editar-perfil/secciones/SecEmpleo";
import SecExperiencia from "@/capacidades/perfiles/perfil-propio/componentes/editar-perfil/secciones/SecExperiencia";
import SecFormacion from "@/capacidades/perfiles/perfil-propio/componentes/editar-perfil/secciones/SecFormacion";
import SecTitulos from "@/capacidades/perfiles/perfil-propio/componentes/editar-perfil/secciones/SecTitulos";
import SecHabilidades from "@/capacidades/perfiles/perfil-propio/componentes/editar-perfil/secciones/SecHabilidades";
import SecContacto from "@/capacidades/perfiles/perfil-propio/componentes/editar-perfil/secciones/SecContacto";
import SecDocumentos from "@/capacidades/perfiles/perfil-propio/componentes/editar-perfil/secciones/SecDocumentos";
