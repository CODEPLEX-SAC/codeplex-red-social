...
} from "@/capacidades/planes/suscripciones/restaurante.data";
...
function SelectorPlanRestaurante({ estaAbierto, alCerrar, alProcederPago }) {
 ...
 <div className="bg-surface rounded-[var(--radius-xl)] w-full max-w-[740px] max-h-[90vh] overflow-hidden relative flex flex-col [animation:modal-slide_0.28s_cubic-bezier(0.34,1.56,0.64,1)] shadow-[0_24px_80px_rgba(0,0,0,0.22)]">
 ...
 <button
 className={`outline-none w-full py-[10px] rounded-[var(--radius-sm)] text-[13.5px] font-bold cursor-pointer transition-all mt-auto${planSeleccionado === "gratis" ? " bg-[#F97316] text-white border-0" : " bg-transparent border-2 border-[#F97316] text-[#F97316] hover:bg-[#F97316] hover:text-white"}`}
 ...
 <button
 className={`outline-none w-full py-[10px] rounded-[var(--radius-sm)] text-[13.5px] font-bold cursor-pointer transition-all mt-auto${planSeleccionado === "basico" ? " bg-[#F97316] text-white border-0" : " bg-transparent border-2 border-[#F97316] text-[#F97316] hover:bg-[#F97316] hover:text-white"}`}
 ...
 <button
 className={`outline-none w-full py-[10px] rounded-[var(--radius-sm)] text-[13.5px] font-bold cursor-pointer transition-all mt-auto border-2 border-white text-[#F97316]${planSeleccionado === "gold" ? " bg-white/85" : " bg-surface hover:bg-white/85"}`}
