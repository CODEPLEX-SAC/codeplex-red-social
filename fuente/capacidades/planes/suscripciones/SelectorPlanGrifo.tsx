...
} from "@/capacidades/planes/suscripciones/grifo.data";
...
function SelectorPlanGrifo({ estaAbierto, alCerrar, alProcederPago }) {
 ...
 <button
 className={`outline-none w-full py-[10px] rounded-[var(--radius-sm)] text-[13.5px] font-bold cursor-pointer transition-all mt-auto${planSeleccionado === "gratis" ? " bg-[#B91C1C] text-white border-0" : " bg-transparent border-2 border-[#B91C1C] text-[#B91C1C] hover:bg-[#B91C1C] hover:text-white"}`}
 ...
 <button
 className={`outline-none w-full py-[10px] rounded-[var(--radius-sm)] text-[13.5px] font-bold cursor-pointer transition-all mt-auto${planSeleccionado === "grifo" ? " bg-white/15 border-0 text-white" : " bg-transparent border-2 border-white/70 text-white hover:bg-white/15 hover:border-white"}`}
