...
} from "@/capacidades/planes/suscripciones/facturacion.data";
...
function PopoverDetalleFeature({ nombreFeature, onCerrar }) {
 ...
 >
 <button
 className="absolute top-[10px] right-[10px] w-[22px] h-[22px] rounded-full bg-base border-none cursor-pointer flex items-center justify-center transition-colors duration-150 hover:bg-line outline-none focus:outline-none"
 onClick={onCerrar}
 >
 ...
 <p className="text-[12.5px] text-fg leading-[1.6] m-0">{info.desc}</p>
 </div>
 </div>
 );
}
...
function PanelPaquetes({ onCerrar }) {
 ...
 >
 <button
 className="absolute top-3 right-3 w-[26px] h-[26px] rounded-full bg-base border-none cursor-pointer flex items-center justify-center transition-colors duration-150 hover:bg-line outline-none focus:outline-none"
 onClick={onCerrar}
 >
 ...
 <h3 className="text-[18px] font-extrabold text-fg m-0 mb-[4px]">Paquetes Adicionales</h3>
 <p className="text-[12.5px] text-muted m-0 mb-4 leading-[1.4]">
 ...
 <div className="text-[11px] text-muted mt-[2px]">{p.tarifa}</div>
 </div>
...
function SelectorPlanFacturacion({ estaAbierto, alCerrar, alProcederPago }) {
 ...
 <h2 className="text-[22px] font-extrabold text-fg m-0 max-[760px]:text-[19px]">Facturación Electrónica</h2>
 </div>
 ...
 <li
 key={f}
 className={`flex items-start gap-[6px] text-[12px] leading-[1.4] cursor-pointer ${plan.dark ? "text-white/90 hover:[&>span]:text-[#99F6E4]" : "text-fg hover:[&>span]:text-[#0D9488]"}`}
 ...
 >
 <IconoPaquete />
 <span className={`flex-1 font-medium ${plan.dark ? "text-white/70" : "text-muted"}`}>¿Más de 2,000 comprobantes?</span>
 ...
 {/* Hint chat */}
 <div
 className="flex items-center justify-end gap-[6px] mt-[14px] text-[13px] text-muted cursor-pointer hover:text-[#0D9488]"
 ...
 <div
 className="flex items-center gap-[10px] px-[14px] py-[10px] border-b border-line-light bg-surface flex-shrink-0 cursor-pointer"
 onClick={() => setVisorPdf({
 ...
 <div className="flex flex-wrap gap-[6px] px-3 py-2 border-t border-line-light bg-surface flex-shrink-0 max-[760px]:flex-wrap max-[760px]:gap-[6px] max-[760px]:pb-3">
