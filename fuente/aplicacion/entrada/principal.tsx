...
import { SesionProvider, useSesion } from '@/capacidades/identidad/sesion/ContextoSesion';
import { PerfilSocialProvider, usePerfilSocial } from '@/capacidades/perfiles/perfil-propio/ganchos/usarContextoPerfilSocial';
import Sidebar from '@/plataforma/caparazon/disposicion/BarraLateralCaparazon';
import Header from '@/plataforma/caparazon/disposicion/CabeceraCaparazon';
import RedSocial from '@/plataforma/caparazon/tablero/PaginaInicioTablero';
import Login from '@/capacidades/identidad/login/Login';
import { ModalAuthRedSocial } from '@/capacidades/identidad/sesion/ModalAuthRedSocial';
import { ModalOnboardingSocial } from '@/capacidades/identidad/sesion/ModalOnboardingSocial';
import GestionEmpresas from '@/capacidades/organizacion/empresas/GestionEmpresas';
import DatosPersonales from '@/capacidades/identidad/datos-personales/paginas/DatosPersonales';
import DatosFacturacion from '@/capacidades/organizacion/facturacion/DatosFacturacion';
import Buzon from '@/capacidades/mensajeria/buzon/componentes/Buzon';
import Mensajes from '@/capacidades/mensajeria/buzon/componentes/Mensajes';
import Tickets from '@/capacidades/organizacion/tickets/Tickets';
import Mantenedores from '@/capacidades/organizacion/mantenedores/Mantenedores';
import CanjeMonedas from '@/capacidades/planes/monedero/CanjeMonedas';
import Monedero from '@/capacidades/planes/monedero/Monedero';
import Colaboradores from '@/capacidades/organizacion/colaboradores/Colaboradores';
import Monetizacion from '@/capacidades/planes/monetizacion/Monetizacion';
import TiendaAplicaciones from '@/capacidades/planes/aplicaciones/paginas/TiendaAplicaciones';
import VistaPasarelaPago from '@/capacidades/planes/pasarela-pago/VistaPasarelaPago';
import { useCarritoSuscripciones } from '@/capacidades/planes/aplicaciones/ganchos/usarCarritoSuscripciones';
import PaginaCarrito from '@/capacidades/planes/carrito/PaginaCarrito';
import CarritoMobile from '@/capacidades/planes/carrito/CarritoMobile';
import VistaPlaceholder from '@/compartido/interfaz/retroalimentacion/marcadores/VistaPlaceholder';
import PerfilPublico from '@/capacidades/perfiles/perfil-publico/paginas/PerfilPublico';
import PerfilPropio  from '@/capacidades/perfiles/perfil-propio/paginas/PaginaPerfilPropio';
import usePublicaciones from '@/capacidades/publicaciones/ganchos/usarPublicaciones';
