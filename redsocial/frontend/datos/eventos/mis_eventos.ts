...
export const EVENTOS_ORGANIZAS: EventoOrganizas[] = [
  {
    gradiente: 'morado', dia: '24', mes: 'AGO', estado: 'publicado',
  ...
  {
    gradiente: 'azul', dia: '15', mes: 'JUN', estado: 'publicado',
  ...
  {
    gradiente: 'calido', dia: '22', mes: 'JUN', estado: 'publicado',
  ...
  {
    gradiente: 'verde', dia: '05', mes: 'JUL', estado: 'borrador',
...
export const EVENTO_COLABORAS: EventoOrganizas = {
  gradiente: 'rosa', dia: '18', mes: 'JUL', estado: 'colaborador',
...
export const PROXIMOS_LATERAL: EventoLateral[] = [
  { gradiente: 'morado', dia: '24', mes: 'AGO', nombre: 'Concierto Codeplex Live 2026', fechaHora: 'Sáb, 24 Ago 2026 · 7:00 PM', ubicacion: 'Arena 1, Lima', asistentes: '1.2K asistirán' },
