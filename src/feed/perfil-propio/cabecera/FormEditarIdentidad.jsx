...
export default function FormEditarIdentidad({ identidadEnEdicion, actualizarCampo, onCancelar, onGuardar }) {
  return (
    <div className="flex flex-col gap-3 w-full">
      ...
      <div>
        <label className="text-[11px] font-semibold text-[var(--text-dark)] block mb-1">Cargo profesional</label>
        <input className={inputCls} placeholder="Ej: Contador Senior" value={identidadEnEdicion.cargo} onChange={(e) => actualizarCampo("cargo", e.target.value)} />
      </div>
