...
const actionBtnCls = (activo) =>
  `flex items-center gap-2 px-[15px] py-[10px] border border-[var(--border-color)] bg-transparent rounded-[var(--radius-sm)] cursor-pointer text-[14px] transition-all duration-300 ${
    activo
...
function CreadorPublicacion({ onPublicar }) {
  ...
  return (
    <div className="bg-[var(--white-color)] p-[25px] rounded-[var(--radius-md)] shadow-[0_2px_8px_rgba(0,0,0,0.05)] [@media(max-width:480px)]:p-5 [@media(max-width:480px)]:px-[15px]">
      <div className="flex items-center gap-[15px] mb-5">
        ...
        <input
          ...
          className="flex-1 border border-[var(--border-color)] px-[15px] py-3 rounded-[var(--radius-sm)] text-[14px] outline-none transition-all duration-300 bg-[var(--white-color)] text-[var(--text-dark)] focus:border-[var(--primary-color)] focus:shadow-[0_0_0_3px_rgba(127,13,242,0.1)]"
      ...
      <div className="flex justify-between items-center [@media(max-width:768px)]:flex-col [@media(max-width:768px)]:gap-[15px] [@media(max-width:768px)]:items-stretch">
        ...
        <button
          className="border-none px-[30px] py-[10px] rounded-[var(--radius-sm)] text-white font-semibold cursor-pointer transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_4px_12px_rgba(127,13,242,0.3)] disabled:opacity-50 [@media(max-width:768px)]:w-full"
